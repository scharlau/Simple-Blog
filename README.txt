...
Change the app/views/layouts/_header.html.erb file lines that have 'my_name' to ones that use your name instead so that we don't have all blogs with the same title.
